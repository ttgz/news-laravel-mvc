            ...
            <div class="col-md-4 py-3">
                <div class="row fh5co_contact_us_no_icon_difh5co_hover">
                    ...
                    <div class="col-9 align-self-center fh5co_contact_us_no_icon_difh5co_hover_2">
                        ...
                        <span class="d-block c_g fh5co_contact_us_no_text"> {{$contact->numberphone}}</span>
                    </div>
            ...
            <div class="col-md-4 py-3">
                <div class="row fh5co_contact_us_no_icon_difh5co_hover">
                    ...
                    <div class="col-9 align-self-center fh5co_contact_us_no_icon_difh5co_hover_2">
                        ...
                        <span class="d-block c_g fh5co_contact_us_no_text">{{$contact->email}}</span>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
            <div class="col-md-4 py-3">
                <div class="row fh5co_contact_us_no_icon_difh5co_hover">
                    ...
                    <div class="col-9 align-self-center fh5co_contact_us_no_icon_difh5co_hover_2">
                        ...
                        <span class="d-block c_g fh5co_contact_us_no_text"> {{$contact->address}}</span>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                <form class="row" id="fh5co_contact_form" action="/contact/add-contact-request" method="post">
                    ...
                    <div class="col-12 py-3 text-center"> <button type="submit" href="#" class="btn contact_btn">Send Message</button> </div>
                </form>
            </div>
